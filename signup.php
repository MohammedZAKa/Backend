...
<main class="form-signin w-100 m-auto">
  <form method="post" action="">
    <img class="mb-4" src="assets/images/pexels-photo-3756774.jpeg" alt="" width="72" height="57">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingUser" name="username">
      <label for="floatingUse">UserName</label>
    </div>

    <div class="form-floating">
      <input type="text" class="form-control" id="floatingFirst" name="first_name">
      <label for="floatingFirst">First name</label>
    </div>

    <div class="form-floating">
      <input type="text" class="form-control" id="floatingLast" name="last_name">
